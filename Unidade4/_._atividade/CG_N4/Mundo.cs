  ...
  class Mundo : GameWindow
  {
    ...
    protected override void OnKeyDown(OpenTK.Input.KeyboardKeyEventArgs e)
    {
      ...
      //--------------------------------------------------------------
        ...
        objetoSelecionado = null;                     // desmarca objeto selecionado
      else if (e.Key == Key.B)
      ...
      else if (e.Key == Key.Minus) deslocamento -= 0.5f;
      else if (e.Key == Key.Plus) deslocamento  += 0.5f;
      ...
      else if (e.Key == Key.Q) camera.ToString(); //FIXME: não funciona.
      else if (e.Key == Key.W) objetoSelecionado.Matriz.ToString(); //FIXME: não funciona.
